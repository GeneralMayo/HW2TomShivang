...
def main():  # noqa: D103
    ...
    agent = DQNAgent(model, target, preprocessor, history, memory, policy, held_out_states, HELD_OUT_STATES_SIZE, GAMMA,
                     TARGET_UPDATE_FREQ, NUM_BURN_IN, TRAIN_FREQ, BATCH_SIZE, REPLAY_START_SIZE, NUM_ACTIONS)
