...
class Preprocessor:
    ...
    def process_batch(self, samples):
        ...
        for sample in samples:
            ...
            #isn't returned                                                     
            newSamples.append(Sample(states[0:4],sample.a_t,sample.r_t,states[1:5],sample.is_terminal))
...
class ReplayMemory:
    ...
    def sample(self, batch_size, indexes=None):
        ...
        newSamples = []
        for sample in samples:
            newSamples.append(Sample(np.copy sample.s_t,
                sample.a_t,r_t,s_t1,is_terminal))
